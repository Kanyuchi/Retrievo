...
## Now
1. Shaun: locate thesis PDFs (old laptop / Google Drive / external drive) → upload to a KB → run scripts/run_semantic_eval.py with a real-queries yaml (harness ready)
